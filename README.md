...
This might be the start of a visual component for thumbnail selector simple component.
(Add functionality later)


### TODO: Automatic Deploy?
7. Open your new repository and update all instances of `labbook-interactive` to `new-repository` and `Labbook Interactive` to `New Repository`.
...
Merges into production are deployed to http://labbook-interactive.concord.org.

Other branches are deployed to http://labbook-interactive.concord.org/branch/<name>.
...
11. Use https://github.com/concord-consortium/labbook-interactive/releases to create a new release tag
...
Labbook Interactive are Copyright 2018 (c) by the Concord Consortium and is distributed under the [MIT license](http://www.opensource.org/licenses/MIT).
